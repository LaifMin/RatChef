...
ai_model = ChatOllama(model=config["models"]["ai"], temperature=0)
master_server = f"http://{config["ip"]["master"]}:5000/registerWorker"
worker_id =  "test_number_one"
worker_url = f"http://{config["ip"]["worker"]}:5001"
